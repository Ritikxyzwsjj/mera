...
TOKEN = '8175008040:AAEcSArdxEzv1ftSIfyGwrMJqx9KNuS9nTw# Replace with your actual bot token
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f" [➖𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚➖](https://t.me/ddosbgmiserver09)\n\n                                                      ↖️",
    parse_mode="Markdown",
    disable_web_page_preview=True  # This disables the link preview
    )
...
def reset_attack_limit(message):
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [bhanuxyz2](https://t.me/VIPPAIDMOD09) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002512896080"  # Replace with your actual feedback channel ID
